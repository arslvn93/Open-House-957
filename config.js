    ...
    "bundleItems": [
      {
        ...
        "text": "Architectural Floor Plan: https://youriguide.com/142_valley_glen_heights_nw_calgary_ab/doc/floorplan_imperial_en_u.pdf"
      },
      {
        "icon": "fas fa-star",
        "text": "Benefit: Amazing back yard, expansive 44x146-foot lot (7,588 sq ft) backing onto nature reserve & Bow River Pathway"
      },
      {
        "icon": "fas fa-check-circle",
        "text": "Benefit: Golf course community"
      },
      {
        "icon": "fas fa-car",
        "text": "Oversized double garage"
      },
      {
        "icon": "fas fa-key",
        "text": "Detached home, 3 bedrooms, 4 baths"
      },
      {
        "icon": "fas fa-home",
        "text": "Listing price: $1,050,000"
      },
      {
        "icon": "fas fa-map-location-dot",
        "text": "Neighbourhood: Valley Ridge - 50% green space, ravines, golf, Bow River, outdoor amenities"
      },
      {
        "icon": "fas fa-image",
        "text": "Property Listing: https://www.realtor.ca/real-estate/28293039/142-valley-glen-heights-nw-calgary-valley-ridge"
      }
    ]
  },
  "meta": {
